...
namespace Core.Kernel.DataAccess.Repository
{
    internal class Repository : IRepository
    {
        ...
        public bool Update<T>(T entity) where T : class, IEntity => _context.Update(entity);
        ...
        public IQueryable<T> Query<T>(bool noTracking = true) where T : class, IEntity => _context.Query<T>(noTracking);
    }
}